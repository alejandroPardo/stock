				...
				<div class="content-box-content" style="text-align:center">
					...
					<div class="tab-content default-tab" id="tab1" style="text-align:center"> <!-- This is the target div. id must match the href of this div's tab -->
  							...
  							<tbody>
  								<?php
  									...
  									if($row[0]<1){
  										...
  										<div>
										No hay Entradas que Mostrar. Agregue una Entrada haciendo click <a href=\"entryAdmin.php\" >aqui</a>.
										</div>
										</div>
										<tr>
										<tr><td class=\"sized2\" ></td>
  										...
  										$nohay=0;
										$summat = mysql_query("select * from entrada order by date DESC LIMIT 700");
										...
										while ($row = mysql_fetch_assoc($summat)) {
        									...
        									print "<td class=\"sized1\">$row[factura]</td>";
        									print "<td class=\"sized1\">$row[proveedor]</td></tr>";
        								}
        							}
						...
						if($nohay==0){
							echo("<br>
								<br>			
								<a class=\"button\" target=\"_blank\" href=\"reports.php?id=2&cols=3\">Exportar</a>");
						}
							?>					
					</div> <!-- End #tab1 -->     
