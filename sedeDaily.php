	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						...
						<li><a class="current" href="#">Inventario Diario</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<h3>Inventarios Diarios por Sede</h3>
				...
				?>
					<div class="tab-content default-tab" id="tab1" style="text-align:center"> 
						<div class="ajax"></div>
							...
							<div class="site">
								<div class="menu">
								<form id="getdateSede" method="post">				
									<p><label for="date">Fecha de Inventario</label><input type="text" readonly="readonly" class="w16em text-input small-input" id="date" name="date" value="" /></p>
      								...
      								<br>
									<label>Sede</label>              
									<select id="sede" name="sede" class="medium-input">
									<?php
