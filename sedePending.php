	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						...
						<li><a class="current" href="#">Por Procesar en Sede</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<h3>Productos por Procesar en sede</h3>
				...
				<?php
					if ($_GET["op"] == "not"){
						...
						<div>
						Error. No hay productos por procesar en esta sede.
						</div>
						</div>");
					}
				?>
					<div class="tab-content default-tab" id="tab1" style="text-align:center"> 
						<div class="ajax"></div>
							...
							<div class="site">
								<div class="menu">
								<form id="getsedePending" method="post">
									<br>
									<label>Sede</label>              
