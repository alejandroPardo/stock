		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						<li><a class="current" href="#">Nueva Entrada</a></li>
			...
			<div id="factura" style="display: none"> <!-- Messages are shown when a link with these attributes are clicked: href="#messages" rel="modal"  -->
				...
				<?php
					...
					$count=mysql_query("select count(*) from `factura`");
					$row = mysql_fetch_row($count);
					if($row[0]<1){
					...
					print("</div>
					<hr>
					<form action=\"validEntry.php\" method=\"post\">
						<fieldset>
							<h4>Agregar a Almacen</h4>
							...
							<input type=\"text\" id=\"prov\" name=\"prov\" class=\"text-input small-input required\" />
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<?php
					if ($_GET["op"] == "error"){
						...
						<a class=\"close\"><img src=\"resources/images/icons/cross_grey_small.png\" title=\"Close this notification\" alt=\"close\" /></a>
						<div>
						Error. Se debe Introducir un numero de Factura para poder guardar la Entrada.
						</div>
						</div>");
					} else {
						if ($_GET["op"] == "ok"){
						...
						<div class="ajax"></div>
							...
							<div class="site">
								<div class="menu">
									...
									<a class="button" href="entryAdmin.php" id="act">Actualizar</a>
