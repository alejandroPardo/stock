<?php
    ...
    if (!$_GET["op"] == "done"){
		Header("Location: entry.php?op=unit");
    }
?>
...
<script type="text/javascript" src="resources/scripts/usersjs2.js"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						...
						<li><a class="current" href="userUnitEntry.php">Entradas por Unidades</a></li>
					</ul>
				</li> 
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<?php
				echo("<h2>Entradas Pendientes - Sede: $place</h2>");
				if ( $_GET["msg"] == "err" ){
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<h3>Entradas Pendientes</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Entradas por Unidades</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
