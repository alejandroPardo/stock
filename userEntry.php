<?php
    ...
    if (!$_GET["op"] == "done"){
		Header("Location: entry.php?op=peso");
    }
?>
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						<li><a class="current" href="userEntry.php">Entradas por Peso</a></li>
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<h3>Entradas Pendientes</h3>
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Entradas por Peso</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
