...
<script type="text/javascript" src="resources/scripts/jquery.date.js"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<!-- Page Head -->
			<?php
				echo("<h2>Productos Disponibles en $place</h2>");
				if ( $_GET["msg"] == "err" ){
						...
						<table style="margin-left:auto;margin-right:auto;text-align:left" id="theTable" cellpadding="0" cellspacing="0" class="sortable-onload-0 rowstyle-alt colstyle-alt paginate-20">
  							<thead>
  								<tr>
    								...
    								<th class="sortable-numeric">Unidades en Ultima Entrada</th>

  								</tr>
  							</thead>
  							<tbody>
  								<?php
  								$a=mysql_query("select count(*) from product_sede where sede='$sede'");
  								$rs2=mysql_fetch_row($a);
  								if($rs2[0]>0){
  									...
  									while ($row = mysql_fetch_assoc($count)) {
  										...
  										while ($rs = mysql_fetch_assoc($q)) {
        									print "<tr><td class=\"sized1\" >$rs[name]</td>";
        									print "<td class=\"sized1\">$rs[date]</td>";
        									if($rs['pesostock']==-1){
        										print "<td class=\"sized1\">No Aplica</td>";
        									} else {
        										print "<td class=\"sized1\">$rs[pesostock]</td>";
        									}
        									if($rs['unidades']==-1){
        										print "<td class=\"sized1\">No Aplica</td></tr>";
        									} else {
        										print "<td class=\"sized1\">$rs[unidades]</td></tr>";
        									}
        								}
        							}
        						} else {
  										...
  										<div>
										No hay productos disponibles en la sede $place. 
										</div>
										</div>");
										print "<tr><td class=\"sized1\" ></td>";
        								print "<td class=\"sized1\"></td>";
        								print "<td class=\"sized1\"></td>";
        								print "<td class=\"sized1\"></td></tr>";
