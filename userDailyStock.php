...
<script type="text/javascript" src="resources/scripts/usersjs.js"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					...
					<ul>
						...
						<li><a class="current" href="userDailyStock.php">Listado de Inventarios Diarios</a></li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div class="content-box" style="text-align:center"><!-- Start Content Box -->
				...
				<h3>Inventarios Diarios</h3>
					
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab">Tabla de Inventario</a></li> <!-- href must be unique and match the id of target div -->
					</ul>
				...
				<?php
					if ($_GET["op"] == "not"){
						...
						<div>
						Error. No hay Inventario en esta fecha.
						</div>
						</div>");
					}
				?>
						...
						<div class="ajax"></div>
							...
							<div class="site">
								...
								<form id="getdate" method="post">				
									<p><label for="dp-2">Fecha de Inventario</label><input type="text" readonly="readonly" class="w16em text-input small-input" id="date" name="date" value="" /></p>
      								<script type="text/javascript">    
        									var opts = {                             
                								formElements:{"date":"Y-sl-m-sl-d"},
                								showWeeks:true                    
        									};      
        									datePickerController.createDatePicker(opts);
      								</script>
									<?php
									echo("<input type=\"hidden\" id=\"sede\" name=\"sede\" class=\"text-input small-input\" value='$sede'/> ");
									?>
