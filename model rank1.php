...
<script type="text/javascript" src="resources/scripts/jquery.date.js"></script>
	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<!-- Logo (221px wide) -->
			<a href="#"><img id="logo" src="resources/images/membersLogo.png" alt="Simpla Admin logo" /></a>
		  
			<!-- Sidebar Profile links -->
			<div id="profile-links">
			<?php
				echo("Hola, <a href=\"#\" title=\"Edit your profile\">$id</a>, tienes <a href=\"#messages\" rel=\"modal\" title=\"3 Messages\">3 Mensajes</a><br/>");
			?>
				<br />
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li>
					<a href="members.php" class="nav-top-item no-submenu current">
						Dashboard
					</a>       
				</li>
				...
				<li>
					...
					<ul>
						...
						<li><a href="#">Listado de Entradas</a></li>
						<li><a href="#">Entradas por Producto</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li><a href="#">Nueva Salida</a></li>
						<li><a href="#">Listado de Salidas</a></li>
						<li><a href="#">Salidas por Producto</a></li>
					</ul>
				</li>
		...
		<div id="main-content"> <!-- Main Content Section with everything -->
			...
			<div id="footer">
				...
				<small> <!-- Remove this notice or replace it with whatever you want -->
						<a href="members.php">Principal</a> | <a href="#">Mapa del Sitio</a> | <a href="#">Volver al Inicio</a> | &#169; Copyright 2010 StockOnline 
				</small>
			</div><!-- End #footer -->
	</body>
</html>
